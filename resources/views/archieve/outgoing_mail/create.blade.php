        ...
        <div class="container">
            <div class="az-content-body">
                <div class="az-dashboard-one-title">
                    <h4 class="az-dashboard-title" id="title">Tambah Surat Keluar</h4>
                </div>
                <form class="forms-sample" method="post" action="{{ route('archieve.outgoing-mail.store') }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="classification" name="classification">
                            ...
                            @foreach ($classifications as $classification)
                                <option value="{{ $classification->id }}" @if (!is_null(old('classification')) && old('classification') == $classification->id) selected @endif>
                                    {{ $classification->name }}
                                </option>
                            @endforeach
                        </select>
